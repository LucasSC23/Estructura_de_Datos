...
public class TestPersona {
    ...
    public TestPersona() {
        ...
        * */
        personas[0] = p;
        //personas[1] = new Persona(1234567,"Luisa Vera",(byte)28);
        personas[2] = p;
        personas[3] = p;
        //Podemos utilizar el for sin llaves si es que es solo una linea como en este caso, tambien no es necesario agregarle llaves al if
